 ...
 * RIF:    `J-XX.XXX.XXX-X` (prefijo J/G/V/E + 7-8 dígitos + guión + dígito verificador).
 * Phone:  exactamente 11 dígitos numéricos.
 */

export const CEDULA_PATTERN = /^[VEve]-\d{1,2}\.\d{3}\.\d{3}$/;
export const RIF_PATTERN = /^[JGVEjgve]-\d{1,2}\.\d{3}\.\d{3}-\d$/;
...
export const RIF_MESSAGE =
  'El RIF debe tener formato J-XX.XXX.XXX-X (prefijos J, G, V o E)';
...
/** Normaliza el RIF a mayúsculas: `j-...-1` → `J-...-1`. */
